...
<body class="bg-stars">
    ...
    <div class="uk-width-large-1-1 uk-width-1-1 uk-text-center uk-container-center">
        <h5 class="uk-contrast uk-text-bold uk-text-uppercase pos-title-question">Quando você entra em uma festa, você sempre…</h5>
    </div>
    <div class="uk-width-large-1-2 uk-width-1-1 uk-container-center uk-text-center uk-grid pos-container-videos">
        <div class="uk-width-large-1-2 uk-width-1-1 uk-container-center uk-margin-top h-vid p0">
            ...
            <h5 class="uk-contrast uk-text-bold uk-text-uppercase uk-width-8-10 uk-container-center pos-text-video pos-text-video1"><a href="quiz_6.php" onclick="sessionStorage.setItem('Q5', 1);" class="uk-contrast c-white">Faz uma grande entrada</a></h5>
        </div>
        <div class="uk-width-large-1-2 uk-width-1-1 uk-container-center uk-margin-top h-vid p0">
            <a href="quiz_6.php" onclick="sessionStorage.setItem('Q5', 2);">
                <video autoplay playsinline loop class="uk-hidden-small">
            ...
            <h5 class="uk-contrast uk-text-bold uk-text-uppercase uk-width-6-10 uk-container-center pos-text-video pos-text-video2"><a href="quiz_6.php" onclick="sessionStorage.setItem('Q5', 2);" class="uk-contrast c-white">Encontra um amigo para conversar</a></h5>
        </div>
