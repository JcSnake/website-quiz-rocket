...
<body class="bg-stars">
    ...
    <div class="uk-width-large-1-1 uk-width-1-1 uk-text-center uk-container-center">
        <h5 class="uk-contrast uk-text-bold uk-text-uppercase pos-title-question">¿en dónde te quedas en un concierto?</h5>
    </div>
    <div class="uk-width-large-1-2 uk-width-1-1 uk-container-center uk-text-center uk-grid pos-container-videos">
        <div class="uk-width-large-1-2 uk-width-1-1 uk-container-center uk-margin-top h-vid p0">
            ...
            <h5 class="uk-contrast uk-text-bold uk-text-uppercase uk-width-8-10 uk-container-center pos-text-video pos-text-video6"><a href="quiz_7.php" onclick="sessionStorage.setItem('Q6', 1);" class="uk-contrast c-white">rockeo en las filas de enfrente</a></h5>
        </div>
        <div class="uk-width-large-1-2 uk-width-1-1 uk-container-center uk-margin-top h-vid p0">
            <a href="quiz_7.php" onclick="sessionStorage.setItem('Q6', 2);">
                <video autoplay playsinline loop class="uk-hidden-small">
            ...
            <h5 class="uk-contrast uk-text-bold uk-text-uppercase uk-width-8-10 uk-container-center pos-text-video pos-text-video2"><a href="quiz_7.php" onclick="sessionStorage.setItem('Q6', 2);" class="uk-contrast c-white">hasta atrás para vivir la experiencia completa</a></h5>
        </div>
        <div class="uk-text-center uk-width-1-1 uk-hidden-small">
            <span class="uk-contrast">6/10</span>
        </div>
