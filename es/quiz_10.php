...
<body class="bg-stars">
    ...
    <div class="uk-width-large-1-1 uk-width-1-1 uk-text-center uk-container-center">
        <h5 class="uk-contrast uk-text-bold uk-text-uppercase pos-title-question">nunca dejo la casa sin...</h5>
    </div>
    <div class="uk-width-large-1-2 uk-width-1-1 uk-container-center uk-text-center uk-grid pos-container-videos">
        <div class="uk-width-large-1-2 uk-width-1-1 uk-container-center uk-margin-top h-vid p0">
            ...
            <h5 class="uk-contrast uk-text-bold uk-text-uppercase uk-width-8-10 uk-container-center pos-text-video pos-text-video6"><a href="spinner.php" onclick="sessionStorage.setItem('Q10', 1);" class="uk-contrast c-white">Unos asombrosos lentes</a></h5>
        </div>
        <div class="uk-width-large-1-2 uk-width-1-1 uk-container-center uk-margin-top h-vid p0">
            <a href="spinner.php" onclick="sessionStorage.setItem('Q10', 2);">
                <video autoplay playsinline loop class="uk-hidden-small">
            ...
            <h5 class="uk-contrast uk-text-bold uk-text-uppercase uk-width-8-10 uk-container-center pos-text-video pos-text-video2"><a href="spinner.php" onclick="sessionStorage.setItem('Q10', 2);" class="uk-contrast c-white">audífonos para mi música</a></h5>
        </div>
